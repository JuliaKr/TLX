...
public class SaveForm extends javax.swing.JFrame {
    ...
    private void changeComponents(){
        SaveFormListener fListener = new SaveFormListener(this);
        jFileChooser1.addActionListener(fListener);
        FileNameExtensionFilter xmlfilter = new FileNameExtensionFilter("xml files (*.xml)", "xml");
        jFileChooser1.setFileFilter(xmlfilter);
        rueckgabeWert = jFileChooser1.showSaveDialog(null);
        
        
    }
    
    public List<TLXElement> getList(){
        return tlxElements;
    }
    ...
    public void writeXMLFile(List<TLXElement> tlxElements, String path){
        try {
            XMLWriter xmlWriter = new XMLWriter(tlxElements, path);
